<?php
    ...
    $sql="select *, producto.nombre as nombreprod from beneficio, producto where (beneficio.id_beneficio=producto.id_beneficio) order by beneficio.nombre asc";
        ...
        <div class="container">
            <div class="row">
                <div class="col-10"></div>
                    ...
                    <div class="col-2">
                    <a href="../../public/actions/beneficios/form.php" class="btn btn-primary">Agregar</a>
                    <div>
                ...
                <tr>
                    ...
                    <div class="d-sm-inline-block">
                        <form action="verdetalle.php" method="post">
                            <input type="hidden"name="id" id="id" value="<?php echo $fila["id_beneficio"];?>">
